...
export const FAQ_DATA = {
  ...
  dermapen: [
    ...
    },
    {
      ...
      answer: "You may experience mild redness similar to a sun burn for 24 to 48 hours. Most patients return to work the next day."
    },
    {
  ...
  exosome: [
    {
      question: "What exactly are exosomes in skincare and hair care?",
      answer: "Exosomes are tiny extracellular vesicles that act as messengers between cells. In therapy, they deliver essential proteins, growth factors, and genetic material to skin and hair cells to trigger repair and regeneration."
    },
    {
      question: "Is exosome therapy better than PRP?",
      answer: "While PRP uses your own blood's platelets, Exosome therapy uses highly concentrated, lab-purified growth factors that are often more potent and provide more consistent results for severe thinning or aging."
    },
    {
      question: "How long does it take to see results from Exosome therapy?",
      answer: "Initial improvements in skin texture and hair quality can be seen within 4-6 weeks, with significant regenerative results appearing over 3 to 6 months as cellular repair progresses."
    },
    {
      question: "Is the procedure painful?",
      answer: "The procedure is minimally invasive. We use topical numbing creams or fine-needle injection techniques to ensure patient comfort throughout the session."
    },
    {
      question: "Are there any side effects?",
      answer: "Exosome therapy is generally very safe. Some patients may experience mild redness or swelling at the site of application for 24-48 hours, which resolves quickly."
    },
    {
      question: "How many sessions will I need?",
      answer: "For hair restoration, we typically recommend a series of 3 sessions. For skin rejuvenation, results can often be achieved in 1-3 sessions depending on individual skin concerns."
    }
  ],
  prp: [
    {
      question: "Is PRP therapy effective for hair fall?",
      answer: "Yes, PRP (Platelet-Rich Plasma) therapy is a highly effective non-surgical treatment for promoting hair regrowth and improving hair density by stimulating dormant hair follicles using your own blood's healing factors."
    },
    {
      question: "How many PRP sessions are required to see visible results?",
      answer: "Generally, we recommend an initial series of 4 to 6 sessions spaced 4 weeks apart. Maintenance sessions every 6 to 12 months are often suggested for sustained results."
    },
    {
      question: "Is PRP treatment painful?",
      answer: "The procedure involves small injections into the scalp or skin. While you may feel a slight pinching sensation, we use topical numbing agents to ensure the experience is as comfortable as possible."
    },
    {
      question: "Can PRP be used for facial rejuvenation?",
      answer: "Absolutely. When used on the face (often called a 'vampire facial'), PRP helps stimulate collagen production, reduces fine lines, improves skin texture, and gives a natural, healthy glow."
    },
    {
      question: "Is there any downtime after the procedure?",
      answer: "There is virtually no downtime. You may experience slight swelling or redness for a few hours, but most patients return to their normal activities immediately."
    },
    {
      question: "Is PRP therapy expensive in Ludhiana?",
      answer: "Puri Skin Clinic offers highly competitive pricing for PRP treatments in Punjab, making advanced regenerative clinical care affordable and accessible."
    }
  ],
  mesotherapy: [
    {
      question: "What is Mesotherapy treatment?",
      answer: "Mesotherapy is a non-surgical cosmetic treatment involving multiple tiny injections of vitamins, enzymes, antioxidants, and plant extracts into the middle layer of the skin (mesoderm). It is used for skin rejuvenation, hair loss, and fat reduction."
    },
    {
      question: "Is Mesotherapy painful?",
      answer: "The procedure involves very fine needles. Most patients feel only a slight pinching or stinging sensation. We use topical numbing creams to ensure maximum comfort during the session."
    },
    {
      question: "How many sessions are required for visible results?",
      answer: "For optimal results, a series of 4 to 8 sessions is usually recommended, spaced 2 to 3 weeks apart. Maintenance sessions every few months help sustain the results."
    },
    {
      question: "Is there any downtime after the treatment?",
      answer: "There is minimal to no downtime. Some patients may experience slight redness or tiny marks at the injection sites, which typically fade within 24-48 hours."
    },
    {
      question: "Can Mesotherapy help with hair loss?",
      answer: "Yes, Mesotherapy is highly effective for thinning hair. It delivers essential nutrients directly to the hair follicles, stimulating growth and improving scalp health."
    },
    {
      question: "What should I avoid after a session?",
      answer: "Avoid strenuous exercise, hot baths, and direct sun exposure for at least 24 hours. We recommend keeping the treated area clean and hydrated as per our post-care instructions."
    }
  ],
  radioFrequency: [
    {
      question: "How does Radio-Frequency (RF) skin tightening work?",
      answer: "RF treatment uses energy waves to heat the deep layers of the skin (dermis). This controlled heat stimulates the production of new collagen and elastin, resulting in tighter, firmer skin."
    },
    {
      question: "Is RF treatment safe?",
      answer: "Yes, RF skin tightening is a safe, FDA-approved non-surgical procedure. It is effective for all skin types and requires no incisions or general anesthesia."
    },
    {
      question: "Which areas can be treated with RF?",
      answer: "RF is commonly used to tighten skin on the face, neck, jawline, and body areas like the abdomen or thighs where skin sagging is present."
    },
    {
      question: "When will I see the results of RF treatment?",
      answer: "Some immediate tightening is often visible, but the most significant results appear over 2 to 6 months as the body produces new collagen."
    },
    {
      question: "How many sessions are typically needed?",
      answer: "Most patients achieve best results with a series of 3 to 5 sessions, spaced 3 to 4 weeks apart, depending on the severity of skin laxity."
    },
    {
      question: "Does the procedure involve any pain?",
      answer: "Patients typically feel a warm, soothing sensation during the treatment, similar to a hot stone massage. It is generally a very comfortable and relaxing procedure."
    }
  ]
};
